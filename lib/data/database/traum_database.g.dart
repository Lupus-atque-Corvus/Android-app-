...
class $$TodosTableTableManager
    extends
        RootTableManager<
          ...
          (Todo, BaseReferences<_$TraumDatabase, $TodosTable, Todo>),
          Todo,
          PrefetchHooks Function()
        > {
...
final class $$WorkoutPlansTableReferences
  ...
  _workoutSessionsRefsTable(_$TraumDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.workoutSessions,
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({workoutDaysRefs = false, workoutSessionsRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
...
typedef $$WorkoutPlansTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (WorkoutPlan, $$WorkoutPlansTableReferences),
      WorkoutPlan,
      PrefetchHooks Function({bool workoutDaysRefs, bool workoutSessionsRefs})
    >;
...
class $$WorkoutDaysTableTableManager
    extends
        RootTableManager<
          ...
          WorkoutDay,
          PrefetchHooks Function({bool planId, bool workoutSessionsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({planId = false, workoutSessionsRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (workoutSessionsRefs) db.workoutSessions,
    ...
    $WorkoutSessionsTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({planId = false, dayId = false, workoutSetsRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
...
typedef $$WorkoutSessionsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (WorkoutSession, $$WorkoutSessionsTableReferences),
      WorkoutSession,
      PrefetchHooks Function({bool planId, bool dayId, bool workoutSetsRefs})
    >;
...
final class $$BudgetCategoriesTableReferences
  ...
  _transactionsRefsTable(_$TraumDatabase db) => MultiTypedResultKey.fromTable(
    db.transactions,
    aliasName: $_aliasNameGenerator(
...
final class $$TransactionsTableReferences
    extends BaseReferences<_$TraumDatabase, $TransactionsTable, Transaction> {
  $$TransactionsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $BudgetCategoriesTable _categoryIdTable(_$TraumDatabase db) =>
